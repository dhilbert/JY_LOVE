...
$url = 'https://mz-dev.atlassian.net/rest/api/latest/search?jql=updated>='.$info['jirasync_update_date'].'%20AND%20component%20=%20메트라이프&fields=key&maxResults=10000';
...
WHERE STATUS = "닫힘" AND customfield_12269="";';
	...
	echo "<script>
	alert('업데이트 완료.');
	parent.location.replace('/JY_LOVE/05_jira_update/jira_update_main.php');
	</script> ";

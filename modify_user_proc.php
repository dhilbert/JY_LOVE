...
<link href="/JY_LOVE_ADMIN/css/bootstrap.min.css" rel="stylesheet">

<link href="/JY_LOVE_ADMIN/css/datepicker3.css" rel="stylesheet">
<link href="/JY_LOVE_ADMIN/css/styles.css" rel="stylesheet">


<link href="/JY_LOVE_ADMIN/css/bootstrap-table.css" rel="stylesheet">
<link href="/JY_LOVE_ADMIN/css/bootstrap-table.css" rel="stylesheet">

<script src="/JY_LOVE_ADMIN/js/lumino.glyphs.js"></script>

<script type="text/javascript" src="/JY_LOVE_ADMIN/js/loader.js"></script>
...
<?php
	...
	if($update_admin_pw == Null){	
			echo "<script>
				alert('비밀번호를 입력하세요.');
				parent.location.replace('/JY_LOVE/home.php');
			</script> ";
...
if($info==Null) {
		echo "<script>
				...
				parent.location.replace('/JY_LOVE_ADMIN/');
			 </script> ";
}else {
	...
	if($info['admin_pw']==MD5($admin_pw)){
			...
			echo "<script>
				alert('환영합니다.');
				parent.location.replace('/JY_LOVE_ADMIN/home.php');
			</script> ";
